...
//        + UserEntry.USER_ID + " INTEGER , "
        ...
        // Insert Into Table
        db.execSQL("insert into " + TABLE_NAME + inputColumns + " values('11111111111','Mukilan', 1,  'spn@gmail.com','SBI1234','9087654321', 10000)");
        db.execSQL("insert into " + TABLE_NAME + inputColumns + " values('22222222222','Karniya', 1,  'peter@gmail.com','HDFC5678','8097654321', 10000)");
        db.execSQL("insert into " + TABLE_NAME + inputColumns + " values('33333333333','Mridhula', 1,  'norman@gmail.com','BOI9012','7098654321', 10000)");
        db.execSQL("insert into " + TABLE_NAME + inputColumns + " values('44444444444','Swetha', 0,  'mary@gmail.com','SBI3456','8098754321', 10000)");
        db.execSQL("insert into " + TABLE_NAME + inputColumns + " values('55555555555','Pravin', 1,'otto@gmail.com','AXIS7890','9098764321', 10000)");
        db.execSQL("insert into " + TABLE_NAME + inputColumns + " values('66666666666','Hema', 0, 'gwen@gmail.com','BOI1357','8998765321', 10000)");
